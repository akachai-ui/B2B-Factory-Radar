...
export function DBDCompanyExplorer({ 
  companyId, 
  userId, 
  canExport = false, 
  onClaimSuccess,
              ...
              <div className="flex items-center gap-2">
                ...
                {isProUnlocked ? (
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-850 hover:bg-slate-800 border border-slate-750 text-xs font-semibold text-amber-400 hover:text-amber-300 transition-colors cursor-pointer"
                  >
