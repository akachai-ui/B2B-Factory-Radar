...
export const UserMenu: React.FC<UserMenuProps> = ({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown Menu */}
      {dropdownOpen && (
        <div className="absolute right-0 mt-2 w-64 rounded-2xl bg-slate-900 shadow-2xl border border-slate-700/90 py-2 z-[1000] text-slate-200 animate-in fade-in zoom-in-95 duration-150">
