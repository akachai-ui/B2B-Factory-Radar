...
export const translations: Record<Language, Record<string, string>> = {
  th: {
    ...
    heroSubtitle: 'ฐานข้อมูลโรงงานฉีดพลาสติก 1,089 แห่ง พร้อมพิกัด GPS แม่นยำตรงประตูทางเข้า, เบอร์ตรงต่อสายฝ่ายจัดซื้อ/วิศวกรรม, ระบบคัดกรองโซน และ Company Quick Fact เช็กทุนจดทะเบียนประเมินไซส์โรงงาน',
    ...
    // Zones & Territories
    zoneAll: '🌐 ทุกโซน / ทุกพื้นที่ (1,089 แห่ง)',
    zoneBangPhli: '📍 โซนบางพลี (384 แห่ง)',
    zoneKingKaew: '📍 โซนกิ่งแก้ว - ราชาเทวะ',
    ...
    zonePhraPradaeng: '📍 โซนพระประแดง (114 แห่ง)',
    zoneSuksawat: '📍 โซนสุขสวัสดิ์',
